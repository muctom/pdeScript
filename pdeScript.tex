...
\begin{proof}
  % We use the convolution. For simlicity consider the case \(\Omega = \mathbb{R}^d\) first. Take \(\eta \in C_c^\infty(\mathbb{R}^d)\), \(0 \le \eta \le 1\), \(\eta(x) = 0\) if \(|x| \g 1\), \(\eta\) radial.
