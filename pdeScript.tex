...
\begin{document}
  ...
  % \begin{proof}[Solution]
  %   If \(g \in L^1(\mathbb{R}^d) \int g = 1, g_\epsilon(x) = \epsilon^{-d} g(\epsilon^{-1} x)\), then: \(g_\epsilon \star f \to f\) in \(L^1(\mathbb{R}^d)\)
  ...
  \begin{thm}
    ...
    \begin{enumerate}[label=\alph*)]
      ...
      \item For all \(g \in L^1(\Omega_g)\) compactly supported in \(\Omega_f\)it holds:
  ...
  \begin{thm}[Approximation of \(W_{loc}^{\frac{1}{p}}(\Omega)\) by \(C^\infty(\Omega)\)]
    Let \(\Omega \subseteq \mathbb{R}^d\) be open, let \(f \in W_{loc}^{\frac{1}{p}}(\Omega)\). Then there exists \(\{f_n\} \subseteq C^\infty(\Omega)\) such that \(f_n \to f \) in \(W_{loc}^{\frac{1}{p}}(\Omega)\), i.e. for all \(K\) compact in \(\Omega\): \(\|f_n - f\|_{L^p(K)} + \sum_{i=1}^d \| \partial_{x_i}(f_n - f)\|_{L^p(K)} \to 0\) .
  \end{thm}

  \begin{proof}
    Case \(\Omega = \mathbb{R}^d\): Take \(g \in C_c^\infty\), \(\int g = 1\), \(g_\epsilon(x) = \epsilon^{-d} g(\epsilon^{-1}x)\). Then \(g_\epsilon \star f\). Then \(f \in L_{loc}^p(\Omega)\), so \(g_\epsilon \star f \to f\) in \(L_{loc}^p\) as \(\epsilon \to 0\). Moreover \(\partial_{x_i} (g_\epsilon \star \partial_{x_i} f) \to \partial_{x_i} f\) in \(L_{loc}^p\). Then we can take \(f_n = g_{\frac{1}{n} \star f}\)
  \end{proof}

  \begin{rem}
    In general, if we want to compute the distributional derivative \(D^\alpha f\), then we can find \(f_n \to f\) in \(D'(\Omega)\) and compute \(D^\alpha f\). Then \(D^\alpha f_n \to D^\alpha f\) in \(D^\alpha (\Omega)\). As an example we can compute \(\nabla |f|\) with \(f \in W_{loc}^{\frac{1}{p}}(\Omega)\).
    \begin{align*}
      (\nabla |f|)(x)
      &= \begin{cases}
        \nabla f(x) & f(x) > 0 \\
  ...
  \begin{thm}[Chain Rule]
    let \(G \in C^1(\mathbb{R}^1)\) with \(|\nabla G|\) is bounded. Let \(f = (f_i)_{i=1}^d \subseteq W_{loc}^{\frac{1}{p}}(\Omega)\). Then \(x \mapsto G(f(x)) \in W_{loc}^{\frac{1}{p}}(\Omega)\) and
    \begin{align*}
      \partial_{x_i} G(f)
      &= \sum_{k=1}^d \partial_k G(f) \partial_{x_i} f_k \quad \text{ in } D'(\Omega)
    \end{align*}
    Moreover, if \(G(0) \in L^p(\Omega)\) (i.e. either \(|\Omega| < \infty\) or \(G(0) = 0\)), then if \(f = (f_i)_{i=1}^d \subseteq W^{\frac{1}{p}}(\Omega)\), then \(G(f) \in W^{\frac{1}{p}}(\Omega)\).
  \end{thm}
  ...
  \begin{proof}
    ...
    So \(G(f) \in L_{loc}^p\). Let us compute \(\partial_{x_i} G(f)\). Let \(\{f^{(n)}\}_{n=1}^\infty \subseteq C^\infty\) such that \(f^{(n)} \to f\) in \(W_{loc}^{\frac{1}{p}}\), then: 
    \begin{align*}
      |G(f(^n)) - G(f)|
    ...
    \end{align*}
    So \(G(f) \in W_{loc}^{\frac{1}{p}}(\Omega)\). Aussume that \(G(0) \in L^p(\Omega)\) (i.e. \(|\Omega| < \infty\) or \(G(0) = 0\)). If \(f \in W^{\frac{1}{p}}(\Omega)\), then \(G(f) \in W^{\frac{1}{p}}(\Omega)\) since
    \begin{align*}
      |G(f) - G(0) | \le \|\nabla G\|_{L^\infty} |f| \in L^p \Rightarrow G(f) \in L^p
    \end{align*}
    and 
    \begin{align*}
      \partial_{x_i} G(f) = \sum_k \underbrace{\partial_k G}_{\in L^\infty} \underbrace{\partial_i f_k}_{\in L^p} \in L^p \Rightarrow G(f) \in W^{\frac{1}{p}}(\Omega)
    \end{align*}
  \end{proof}

  
  \begin{thm}[Derivative of absolute value] Let \(\Omega \subseteq \mathbb{R}^d\) be open. Let \(f \in W^{\frac{1}{p}}(\Omega)\). 
    Then \(|f| \in W^{\frac{1}{p}}(\Omega)\)
  ...
  \begin{align*}
    |T(\phi_n) - T(\phi)| 
    \le \int_{\mathbb{R}^d} |\phi_n - \phi| \, d\mu(x) \le \|\phi_n - \phi\|_{L^\infty} \left(\int_{K} \, d \mu \right) \to 0
  \end{align*}
