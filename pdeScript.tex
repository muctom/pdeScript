...
\begin{document}
  ...
  \begin{rem}
    If \(d = 1\), \(W^{1,p} \subseteq C(\bar \Omega)\), then the theorem gives a full characterization for \(W_0^{1,p}\), but if \(d \ge 2\), then in general \(W^{1,p} \nsubseteq C(\Omega)\). (later)
  \end{rem}
  ...
  \begin{proof}
    ...
    \begin{itemize}
      ...
      \begin{rem}[Reminder from functional analysis]
        Let \(H\) be a Hilbert space. We say that \(v_n \to v\) if \(\|v_n - v\| \to 0\) and \(v_n \to v\) if \(\langle v_n, \phi \rangle \to \langle v, \phi \rangle\) for all \(\phi \in H\).
      \end{rem}
  ...
  \begin{lem}[Trace on \(\mathbb{R}_+^d\)] if \(u \in C_c^\infty(\mathbb{R}^d)\), then:
    \begin{align*}
      \|u|_{\partial \mathbb{R}_+^d}\| \le C \|u\|_{H^1(\mathbb{R}^d)} \quad \text{with } C > 0 \text{ independent of \(u\).}
    \end{align*}
  \end{lem}
