...
\begin{document}
  ...
  \begin{proof}[Solution]
    ...
    \begin{align*}
      ...
      &= f(0) \int_{\mathbb{R}^d} g(x) \, dx
    \end{align*}
  \end{proof}


  \begin{rem}
    Let \(g \in C_c(\mathbb{R}^d)\) be radial. Why is \(\int_{\mathbb{R}^3} \frac{q(x)}{|x|} \,dx \ne \infty\)? Because \(f(x) = \frac{1}{|x|}\) is harmonic in \(\mathbb{R}^d \setminus \{0\}\) and sub-harmonic in \(\mathbb{R}^d\), \(- \Delta = c \delta_0\).
  \end{rem}
  ...
  \begin{ex}[E 5.5]
    \(B = B(0, \frac{1}{2}) \subseteq \mathbb{R}^3\), \(r = |x|\), \(u(x) = \omega(r) = \log|\log(r)|\) for all \(r \in \left(0, \frac{1}{2}\right)\). Compute \(- \Delta u\) in \(D'(B)\), 
  \end{ex}
  ...
  \begin{proof}[Solution]
    ...
    \begin{align*}
      ...
      \left(\begin{aligned}
        ...
        x \in (\log(2), \infty), \\
        dr = -e^{-x} \, dxs
      \end{aligned}\right) \quad &\tilde < \int_0^{\frac{1}{2}} \frac{1}{r} \left| \frac{1}{(\log(r))^2} - \frac{1}{(\log(r))} \right|^{\frac{3}{2}} \, dr \\
      &\tilde < \int_{\log(2))}^\infty e^x \left(\frac{1}{x^2} + \frac{1}{x}\right)^{\frac{3}{2}} e^{-x} \, dx \\
    ...
    \end{align*}
    for all \(x \ne 0, |x| = r < \frac{1}{2}\). Why is \(- \Delta u(x) = f\) in \(D'(B)\)? Take \(\phi \in C_c^\infty(B)\), check: \(\int_B(-\Delta \phi) = \int_B f d \phi\). 
    \begin{align*}
