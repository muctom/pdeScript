...
\begin{document}
  ...
  \begin{proof}[Solution]
    ...
    \end{align*}
    This function depens on \(x\) only via \(|x|\). 
    \begin{align*}
    ...
    \begin{align*}
      ...
      &= \fint_{\partial B(0, |x|)} \left(\fint_{\partial B(0, r)} \frac{dS(y)}{|z-y|}\right) \, dS(y) \\
      (\text{Fubini}) \quad &= \fint_{\partial B(0,r)} \left(\fint_{\partial B(0, |x|)} \frac{dS(z)}{|z-y|}\right) \, dS(y) \\
      (\text{case 1 since \(|y| = r > |x|\))} \quad &= \fint_{\partial B(0,r)} \left(\frac{1}{|y|}\right) \, dS(y)
      = \frac{1}{r}
    \end{align*}
    If \(|x| = r\): Continuiti: \(x \mapsto \fint_{\partial B(0, r)} \frac{dS(y)}{|x-y|}\)
  \end{proof}
  ...
  \begin{ex}[Bonus 2]
    Consider \(u(x) = \frac{1}{|x|}\) in \(\mathbb{R}^d\). 
    \begin{enumerate}
      \item Prove that \(u\) is sub-harmonic in \(\mathbb{R}^2 \setminus \{0\}\). 
  ...
  \begin{thm}[Basic Properties]
    \begin{enumerate}
      % \item If \(f \in L^1(\mathbb{R}^d)\), then \(\hat f \in L^\infty(\mathbb{R}^d)\) and \(\|\hat f \|\_{L^\infty} = \|L\|_{L^?})\)
      \item For all \(f \in L^1(\mathbb{R}^d) \cap L^2(\mathbb{R}^d)\), \(\|\hat f\|_{L^2} = \|f\|_{L^2}\). Moreover, \(F\) can be extendet to be a unitary transforamtion \(L^2(\mathbb{R}^d) \to L^2(\mathbb{R}^d)\) s.t.
      % \item \[\|F g\|_{L^2} = \|f\|_{L^2} \quad \forall f \in L^2(Á\mathbb{R}^d)\]
      % \item The inverse of \(F\) can be depied as
      % \item \[(F^{-1}f)(x) = \check f (x) = \int_{\mathbb{R}^d} f(x) e^{2 \pi ik x} \, dk\] for all \(f \in L^1(\mathbb{R}^d) \cap L^2(\mathbb{R}^d)\)
      \item \(\widehat{D^\alpha f}(k) = (2 \pi i k)^\alpha \hat f(k)\) as laj as \((2 \pi ik)^k f(k) \in L^2(\mathbb{R}^d)\) (\(k^\alpha = k_1^{alpha_1} \cdots k_\alpha^{\alpha_k}\))
  ...
  \begin{thm}[Hausdorff-Young-Inequality]
    ...
    \[F: \quad L^P(\mathbb{R}^d) \to L^p(\mathbb{R}^d)\]
    and 
  ...
  \begin{rem}
    ...
    \begin{align*}
      ...
      \int_{\mathbb{R}^d} |f_1| = \int_{\mathbb{R}^d} |f| \mathbb{1}(|f| \ge 1) \le \int_{\mathbb{R}^d} |f|^p < \infty
    \end{align*}
    ...
    % \end{align*}
    We want to deque the Fourier transform for singular function, e.g. \(\frac{1}{|x|}\). Poisson:
    \begin{align*}
    ...
    \begin{align*}
      ...
      \Rightarrow u(x) = (G \star g) (x) = \int_{\Rd} G(x-y)f(y)\, dy
    \end{align*}
  ...
  \begin{rem}
    ...
    Question: If \(f = \tilde f_1 + \tilde f_2\), where \(\tilde f_1 \in L^1\) and \(\tilde f_2 \in L^2\), do we have that \(\hat f_1 + \hat f_2 = \hat{\tilde f_1} + \hat{\tilde f_2} \in L^1 \cap \L^2\)?
    In fact:
    \begin{align*}
  ...
  \begin{proof}[Proof of Theorem]
    ...
    \begin{align*}
      \frac{c_\alpha}{|x|^\alpha} \star f = \left(\frac{c_{d-\alpha}}{|f|^{d-\alpha}} \hat f (k) \right)^\check \\
  ...
  \begin{rem}
    If \(d \ge 3\)
    \begin{align*}
      \hat G(k) = \frac{1}{|2 \pi k|^2}  \\
      \Rightarrow G(x) = \left(\frac{1}{|2 \pi k|^2}\right)^\check = \frac{1}{d(d-2(k) |x|^{d-2})} = fundamential solution of laplace
    \end{align*}
  \end{rem}
