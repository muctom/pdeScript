...
\begin{ex}[Bonus 1]\label{bonus-1}
  ...
  \begin{align*}
    ...
    \end{cases}
  \end{align*}
  Proof that \begin{enumerate}[label=\alph*)]
...
\begin{proof}[My Solution]
  \begin{enumerate}[label=\alph*)]
    ...
    \item We proof this by contraposition. Assume there is a \(x_0 \in \Omega\) s.t. \(u(x_0) = 0\). Since we have \(u \ge 0\) on \(\Omega\) by a), it follows that
