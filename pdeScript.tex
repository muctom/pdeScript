...
\begin{document}
  ...
  \begin{thm}[Fourier Transform of \(\frac{1}{|x|^d}\) for \(0 < \alpha < d\)]. We have permally
    \begin{align*}
      \widehat{\frac{c_\alpha}{|x|^\alpha}} = \frac{c_{d-\alpha}}{|k|^{d - \alpha}} \forall 0 < \alpha < d
    \end{align*}
    Here
    \begin{align*}
    ...
    \begin{align*}
      \frac{c_\alpha}{|x|^\alpha}\star f = \widecheck{\left(\frac{c_{d-\alpha}}{|k|^{d + \alpha}} \hat f (k)\right)}
    \end{align*}
    Moreover if \(\alpha < \frac{d}{2}\), then we also have
    \begin{align*}
      \left(\frac{c_\alpha}{|x|^\alpha j} \star f\right)^\land = \frac{c_{d - \alpha}}{|f|^{d-\alpha}} \hat f (k)
    \end{align*}
