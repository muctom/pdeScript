...
\begin{document}
  ...
  \begin{ex}[Bonus 4]
    Let \(T \in D'(\mathbb{R}^d)\) and \(f \in D(\mathbb{R}^d)\). Recall
    \[(f \star T)(y) = T(\tilde f_y) = T(f(y - \cdot)) \in C^\infty(\mathbb{R}^d)\]
    Prove that if \(\int_{\mathbb{R}^d} f = 1\) and \(f_\epsilon(x) = \epsilon^{-d} f(\epsilon^{-1} x)\), then: \(f_\epsilon \star T \to T\) in \(D'(\mathbb{R}^d)\) as \(\epsilon \to 0\)
  \end{ex}
  ...
  \begin{defn}
    ...
    A function is called a weak solution (a distributional solution) if 
  ...
  \begin{thm}[Low Regularity for Poisson Equation]\label{Low Regularity for Poisson Equation}
  ...
  \begin{proof}[Proof of theorem \ref{Low Regularity for Poisson Equation}]
    \begin{enumerate}[label=\alph*)]
      \item (\(p=1\)) Why is \(G \star f \in L_{loc}^q\)? Recall from the proof of Youngs inequality:
      \item \begin{align*}
        |(G\star f)(x)| 
