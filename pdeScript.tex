...
\begin{ex}[E 11.1]
  ...
  \begin{enumerate}[label=\alph*)]
    ...
    \item Still to \TeX
  \end{enumerate}
  Prove \(u \in C^\infty(\mathbb{R}^d \times (0, \infty))\).
\end{ex}
...
\begin{proof}[Solution]
  \begin{enumerate}[label=\alph*)]
    ...
    Consequently:
    \begin{align*}
      D_x^\alpha(x,t) &= \int_{\mathbb{R}^d} \underbrace{e^{-t|2 \pi k|^2} \hat g(k) (2 \pi ik)^\alpha}_{L^1(\mathbb{R}^d, dk)} e^{2 \pi i k x} \, dk \in C(\mathbb{R}^d, (0,\infty)) \\
      D_t^\alpha(x,t) &= \int_{\mathbb{R}^d} (-|2\pi k|^2)^\alpha e^{-t|2\pi k|^2} \hat g(k) e^{2 \pi ikx} \, dk \in C(\mathbb{R}^d, (0,\infty))
    \end{align*}
    Also:
    \begin{align*}
      &\partial_t u - \Delta_x u \\&\quad= \int_{\mathbb{R}^d} -|2 \pi k|^2 e^{-t|2 \pi k|^2} \hat g(k) e^{2 \pi i k x} \, dk + \int_{\mathbb{R}^d} e^{-t |2 \pi k|^2} \hat g(k) |2 \pi i k|^2 e^{ 2 \pi i k x} \, dk = 0
    \end{align*}
    \item Finally:
    \begin{align*}
    ...
    \end{align*}
    \item Assume \(g \in H^1(\mathbb{R}^d)\) \(\Leftrightarrow\) \(\int_{\mathbb{R}^d} {1 + |2 \pi k|^2})|\hat g(k)|^2 \, dk < \infty\).
    \begin{align*}
    ...
    \end{align*}
    Claim: for all \(s \ge 0\), \(\left|1 - e^{-s}\right| \le \min(1,cs) \le C \sqrt{s}\). We have that \(s \mapsto \left|\frac{1-e^{-s}}{s}\right|\) is bounded and continuous in \([0,1]\) as \(\left| \frac{1 - e^{-s}}{s}\right| \to 1\), so \(\frac{1-e^{-s}}{s} \le C\) for all \(s \in [0,1]\)
  \end{enumerate}
\end{proof}


\begin{rem}[Heat Equation in bounded set]
  Let \(\Omega \subseteq \mathbb{R}^d\) be open bounded with \(C^1\)-boundary.
  \[\begin{cases}
    \partial_t u - \Delta_x u = 0 &(x,t) \in \Omega \times (0,\infty) \\ u(x,0) = g(x) &u(x,t) = 0 \text{ if } x \in \partial \Omega
  \end{cases}\]
  ...
  \begin{enumerate}[label=Step \arabic*:]
    ...
    \begin{eg}
      ...
      \[
        \begin{cases}
          \partial_t - \Delta_x u = 0 &\text{in } (x,t) \in (0,1) \times (0,\infty) \\ u(x,0) = g(x) \\ u(x,t) = 0, x \in \{0,1\}
        \end{cases}
      \]
      has a solution:
      \begin{align*}
...
\begin{ex}[E 11.3]
  \[\begin{cases}
    \partial_t u - \Delta_x u = 0 & (x,t) \in \mathbb{R}^d \times (0,\infty) \\ u(x,0) = 0 & x \in \mathbb{R}^d
  \end{cases}\]
  \[u(x,t) = \sum_{n=0}^\infty \frac{g^{(n)}(t)}{(2n)!} x^{2n} \quad \forall (x,t) \in \mathbb{R} \times (0,\infty)\]
  where \(g(t) = e^{-\frac{t}{t^2}}\) (also ok \(g(t) = e^{-\frac{1}{t^s}}, s>1\)).
\end{ex}
